		...
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = "querylist.php"><i class = "glyphicon glyphicon-tasks"></i> Query </a></li>
					...
					<table id = "table" class = "table table-bordered">
						...
						<tbody>
							...
							<tr>
								<td>
									<?php
										$qstudent = $conn->query("SELECT * FROM `student` WHERE `student_id` = '$freturn[student_id]'") or die(mysqli_error());
